...
accelerate launch examples/ltx2/model_training/train.py \
  --dataset_base_path /mnt/bn/genai-nebula/wangjie/Video_Gen_Long/DiffSynth-Studio/data/train_data \
  --dataset_metadata_path /mnt/bn/genai-nebula/wangjie/Video_Gen_Long/DiffSynth-Studio/data/train_data/metadata.csv \
